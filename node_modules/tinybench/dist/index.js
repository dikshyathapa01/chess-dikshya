...
var l1 = (e, n, t) => n in e ? h1(e, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[n] = t;
var P = (e, n, t) => l1(e, typeof n != "symbol" ? n + "" : n, t), z = (e, n, t) => n.has(e) || $("Cannot " + t);
var b = (e, n, t) => (z(e, n, "read from private field"), t ? t.call(e) : n.get(e)), O = (e, n, t) => n.has(e) ? $("Cannot add the same private member more than once") : n instanceof WeakSet ? n.add(e) : n.set(e, t), y = (e, n, t, s) => (z(e, n, "write to private field"), s ? s.call(e, t) : n.set(e, t), t);
var B = (e, n, t, s) => ({
  set _(r) {
    y(e, n, r, t);
  },
...
// node_modules/.pnpm/yocto-queue@1.2.0/node_modules/yocto-queue/index.js
var I = class {
  constructor(n) {
    P(this, "value");
    P(this, "next");
  ...
  enqueue(n) {
    let t = new I(n);
    b(this, f) ? (b(this, g).next = t, y(this, g, t)) : (y(this, f, t), y(this, g, t)), B(this, w)._++;
  }
  dequeue() {
    let n = b(this, f);
    if (n)
      return y(this, f, b(this, f).next), B(this, w)._--, n.value;
  }
  peek() {
    if (b(this, f))
      return b(this, f).value;
  }
  clear() {
    y(this, f, void 0), y(this, g, void 0), y(this, w, 0);
  }
  get size() {
    return b(this, w);
  }
  ...
  *drain() {
    let n;
    for (; (n = this.dequeue()) !== void 0; )
      yield n;
  }
};
f = new WeakMap(), g = new WeakMap(), w = new WeakMap();

// node_modules/.pnpm/p-limit@6.2.0/node_modules/p-limit/index.js
function k(e) {
  C(e);
  let n = new E(), t = 0, s = () => {
    t < e && n.size > 0 && (n.dequeue()(), t++);
  }, r = () => {
    t--, s();
  }, o = async (a, h, u) => {
    let m = (async () => a(...u))();
    ...
    new Promise((m) => {
      ...
      o.bind(void 0, a, h, u)
    ), (async () => (await Promise.resolve(), t < e && s()))();
  }, c = (a, ...h) => new Promise((u) => {
    i(a, u, h);
  });
...
var _ = Object.freeze({
  ...
  infinity: 1.96
}), V = 1e3, W = 64, H = 250, D = 16, T = Object.freeze(() => {
});
...
var Y, G, m1 = !!globalThis.Bun || !!((G = (Y = globalThis.process) == null ? void 0 : Y.versions) != null && G.bun), p1 = !!globalThis.Deno, U, X, f1 = ((X = (U = globalThis.process) == null ? void 0 : U.release) == null ? void 0 : X.name) === "node", d1 = !!globalThis.HermesInternal, Z, b1 = (
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-member-access
  !!globalThis.$262 && // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-member-access
  !!globalThis.lockdown && // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-member-access
...
), v = m1 ? "bun" : p1 ? "deno" : f1 ? "node" : d1 ? "hermes" : v1 ? "netlify" : g1 ? "edge-light" : w1 ? "lagon" : k1 ? "fastly" : b1 ? "workerd" : y1 ? "quickjs-ng" : T1 ? "moddable" : E1 ? "v8" : S1 ? "spidermonkey" : R1 ? "jsc" : x1 ? "browser" : "unknown", o1 = (() => {
  var e, n, t, s, r, o, i, c, a, h, u, m;
  return v === "bun" ? (e = globalThis.Bun) == null ? void 0 : e.version : v === "deno" ? (t = (n = globalThis.Deno) == null ? void 0 : n.version) == null ? void 0 : t.deno : v === "node" ? (r = (s = globalThis.process) == null ? void 0 : s.versions) == null ? void 0 : r.node : v === "hermes" ? (c = (i = (o = globalThis.HermesInternal) == null ? void 0 : o.getRuntimeProperties) == null ? void 0 : i.call(o)) == null ? void 0 : c[
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    "OSS Release Version"
  ] : v === "v8" ? (a = globalThis.version) == null ? void 0 : a.call(globalThis) : v === "quickjs-ng" ? (m = (u = (h = globalThis.navigator) == null ? void 0 : h.userAgent) == null ? void 0 : u.split) == null ? void 0 : m.call(u, "/")[1] : "unknown";
})(), a1 = (e) => e / 1e6, L = (e) => e * 1e6, F = (e, n, t) => Math.abs(e) >= 10 ** n ? e.toFixed() : Math.abs(e) < 10 ** (n - t) ? e.toFixed(t) : e.toPrecision(n), N, r1, i1;
typeof ((i1 = (r1 = globalThis.process) == null ? void 0 : r1.hrtime) == null ? void 0 : i1.bigint) == "function" ? N = globalThis.process.hrtime.bigint.bind(process.hrtime) : N = () => {
  throw new Error("hrtime.bigint() is not supported in this JS environment");
};
var O1 = () => a1(Number(N())), A1 = performance.now.bind(performance), q = A1, d = (e) => e !== null && typeof e == "object" && typeof e.then == "function", M1 = (e) => (
  ...
  return e.reduce((n, t) => n + t, 0) / e.length || 0;
}, L1 = (e, n = j(e)) => e.reduce((s, r) => s + (r - n) ** 2, 0) / (e.length - 1) || 0, R = (e, n) => {
  if (e.length === 0)
    throw new Error("samples must not be empty");
  if (n < 0 || n > 1)
  ...
  if (n === 1)
    return e[e.length - 1];
  let t = (e.length - 1) * n, s = Math.floor(t);
  return e[s + 1] != null ? (
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    e[s] + // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    (t - s) * (e[s + 1] - e[s])
  ) : e[s];
}, c1 = (e) => R(e, 0.5), F1 = (e) => c1(e.sort((n, t) => n - t)), Q = (e, n, t = n(e)) => {
  let s = [];
  for (let r of e)
    s.push(Math.abs(r - t));
  return n(s);
}, J = (e) => {
  let n = j(e), t = L1(e, n), s = Math.sqrt(t), r = s / Math.sqrt(e.length), o = e.length - 1, i = _[(Math.round(o) || 1).toString()] || _.infinity, c = r * i, a = c / n * 100, h = c1(e);
  return {
    aad: Q(e, j, n),
    critical: i,
    df: o,
...
var x = class extends EventTarget {
  constructor(t, s, r, o = {}) {
     ...
     */
    this.runs = 0;
    this.bench = t, this.name = s, this.fn = r, this.fnOpts = o, this.async = u1(r);
  }
  ...
  async run() {
    ...
    if ((r = this.result) != null && r.error)
      return this;
    this.dispatchEvent(l("start", this)), await ((i = (o = this.bench.opts).setup) == null ? void 0 : i.call(o, this, "run"));
    let { error: t, samples: s } = await this.benchmark(
      "run",
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...
    return await ((a = (c = this.bench.opts).teardown) == null ? void 0 : a.call(c, this, "run")), this.processRunResult({ error: t, latencySamples: s }), this;
  }
  /**
  ...
  runSync() {
    var i, c, a, h, u;
    if ((i = this.result) != null && i.error)
      return this;
    p(
      this.bench.concurrency === null,
      "Cannot use `concurrency` option when using `runSync`"
    ), this.dispatchEvent(l("start", this));
    let t = (a = (c = this.bench.opts).setup) == null ? void 0 : a.call(c, this, "run");
    p(
      !d(t),
      "`setup` function must be sync when using `runSync()`"
    );
    let { error: s, samples: r } = this.benchmarkSync(
      "run",
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      this.bench.opts.time,
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      this.bench.opts.iterations
    ), o = (u = (h = this.bench.opts).teardown) == null ? void 0 : u.call(h, this, "run");
    return p(
      !d(o),
      "`teardown` function must be sync when using `runSync()`"
    ), this.processRunResult({ error: s, latencySamples: r }), this;
  }
  /**
  ...
  async warmup() {
    var s, r, o, i, c;
    if ((s = this.result) != null && s.error)
      return;
    this.dispatchEvent(l("warmup", this)), await ((o = (r = this.bench.opts).setup) == null ? void 0 : o.call(r, this, "warmup"));
    ...
    await ((c = (i = this.bench.opts).teardown) == null ? void 0 : c.call(i, this, "warmup")), this.postWarmup(t);
  }
  /**
  ...
  warmupSync() {
    ...
    let t = (c = (i = this.bench.opts).setup) == null ? void 0 : c.call(i, this, "warmup");
    p(
      !d(t),
      "`setup` function must be sync when using `runSync()`"
    );
    let { error: s } = this.benchmarkSync(
      "warmup",
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      this.bench.opts.warmupTime,
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      this.bench.opts.warmupIterations
    ), r = (h = (a = this.bench.opts).teardown) == null ? void 0 : h.call(a, this, "warmup");
    p(
      !d(r),
      "`teardown` function must be sync when using `runSync()`"
    ), this.postWarmup(s);
  }
  async benchmark(t, s, r) {
    var a, h;
    if (this.fnOpts.beforeAll != null)
      try {
        await this.fnOpts.beforeAll.call(this, t);
      } catch (u) {
        return { error: u };
      }
    let o = 0, i = [], c = async () => {
      this.fnOpts.beforeEach != null && await this.fnOpts.beforeEach.call(this, t);
      let u = 0;
      if (this.async) {
        let m = this.bench.opts.now();
        await this.fn.call(this), u = this.bench.opts.now() - m;
      } else {
        let m = this.bench.opts.now();
        this.fn.call(this), u = this.bench.opts.now() - m;
      }
      i.push(u), o += u, this.fnOpts.afterEach != null && await this.fnOpts.afterEach.call(this, t);
    };
    try {
      let u = k(this.bench.threshold), m = [];
      for (
        ;
        // eslint-disable-next-line no-unmodified-loop-condition
        (o < s || i.length + u.activeCount + u.pendingCount < r) && !((a = this.bench.opts.signal) != null && a.aborted);
      )
        this.bench.concurrency === "task" ? m.push(u(c)) : await c();
      !((h = this.bench.opts.signal) != null && h.aborted) && m.length > 0 && await Promise.all(m);
    } catch (u) {
      return { error: u };
    }
    if (this.fnOpts.afterAll != null)
      try {
        await this.fnOpts.afterAll.call(this, t);
      } catch (u) {
        return { error: u };
      }
    return { samples: i };
  ...
  benchmarkSync(t, s, r) {
    if (this.fnOpts.beforeAll != null)
      try {
        let a = this.fnOpts.beforeAll.call(this, t);
        p(
          !d(a),
    ...
    let o = 0, i = [], c = () => {
      if (this.fnOpts.beforeEach != null) {
        let m = this.fnOpts.beforeEach.call(this, t);
        p(
          !d(m),
          "`beforeEach` function must be sync when using `runSync()`"
        );
      }
      let a = 0, h = this.bench.opts.now(), u = this.fn.call(this);
      if (a = this.bench.opts.now() - h, p(
        !d(u),
        "task function must be sync when using `runSync()`"
      ), i.push(a), o += a, this.fnOpts.afterEach != null) {
        let m = this.fnOpts.afterEach.call(this, t);
        p(
          !d(m),
    ...
    if (this.fnOpts.afterAll != null)
      try {
        let a = this.fnOpts.afterAll.call(this, t);
        p(
          !d(a),
  ...
  processRunResult({
    ...
    if (s) {
      this.runs = s.length;
      let o = s.reduce((h, u) => h + u, 0), i = J(
        s.sort((h, u) => h - u)
      ), c = s.map(
        (h) => h !== 0 ? 1e3 / h : 1e3 / i.mean
      ).sort((h, u) => h - u), a = J(c);
...
var K = class extends EventTarget {
  constructor(t = {}) {
    ...
    this.name = t.name, delete t.name, this.runtime = v, this.runtimeVersion = o1, this.opts = {
      iterations: W,
      now: q,
      setup: T,
      teardown: T,
  ...
  add(t, s, r = {}) {
    ...
    {
      let o = new x(this, t, s, r);
      this._tasks.set(t, o), this.dispatchEvent(l("add", o));
    }
    return this;
  }
  addEventListener(t, s, r) {
  ...
  remove(t) {
    ...
    return s && (this.dispatchEvent(l("remove", s)), this._tasks.delete(t)), this;
  }
  removeEventListener(t, s, r) {
    super.removeEventListener(t, s, r);
  }
  ...
  async run() {
    ...
    if (this.dispatchEvent(l("start")), this.concurrency === "bench") {
      let s = k(this.threshold), r = [];
      for (let o of this._tasks.values())
        r.push(s(o.run.bind(o)));
  ...
  table(t) {
    return this.tasks.map((s) => {
      var r;
      if (s.result) {
        let { error: o, latency: i, throughput: c } = s.result;
        return o ? {
          "Task name": s.name,
          Error: o.message,
          Stack: o.stack
        } : (r = t == null ? void 0 : t(s)) != null ? r : {
          "Task name": s.name,
          "Latency avg (ns)": `${F(L(i.mean), 5, 2)} \xB1 ${i.rme.toFixed(2)}%`,
          // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
          "Latency med (ns)": `${F(L(i.p50), 5, 2)} \xB1 ${F(L(i.mad), 5, 2)}`,
          "Throughput avg (ops/s)": `${Math.round(c.mean).toString()} \xB1 ${c.rme.toFixed(2)}%`,
          // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
          "Throughput med (ops/s)": `${Math.round(c.p50).toString()} \xB1 ${Math.round(c.mad).toString()}`,
  ...
  async warmupTasks() {
    if (this.dispatchEvent(l("warmup")), this.concurrency === "bench") {
      let t = k(this.threshold), s = [];
      for (let r of this._tasks.values())
        s.push(t(r.warmup.bind(r)));
      await Promise.all(s);
    } else
      for (let t of this._tasks.values())
        await t.warmup();
